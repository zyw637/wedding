...
(function () {
    ...
    async play() {
      ...
      try {
        ...
        if (e.name === "NotAllowedError" || e.name === "AbortError") {
          ...
          window.addEventListener("scroll", resumeOnGesture, {
            once: true,
            passive: true,
          });
          return;
  ...
  class ShowcaseController {
    ...
    next(showcaseId) {
      ...
      this.setPhoto(
        showcaseId,
        (showcase.currentIndex + 1) % showcase.photos.length,
      );
    }
  ...
  class ChineseWeddingApp {
    ...
    init() {
      ...
      this.countdown = new CompassCountdown("2026-10-03T11:58:00");
